      ...
      <div className="flex flex-col items-start justify-center w-full max-w-2xl mx-auto mb-16">
        <div className="flex flex-col-reverse sm:flex-row items-start">
          <article className="prose prose-sm md:prose-md text-black dark:text-white">
            ...
            <p>Last updated on November 20, 2022</p>
            <p>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  We, Us or Our in this Agreement) refers to Druker Net
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Druker.net, accessible from
                  www.druker.net
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>
                By visiting this page on our website: www.druker.net/contact
              </li>
              <li>By sending us an email: or@druker.net</li>
            </ul>
            <p></p>
          </article>
        </div>
