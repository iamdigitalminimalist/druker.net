...
const buttonStyle =
  'inline-flex items-center px-6 py-3 border border-transparent text-lg font-bold rounded-md shadow-sm text-neutral-900 bg-neutral-200 hover:bg-neutral-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-500';
...
export const TopicButton = (props: TopicButtonProps) => {
  ...
  return (
    <button type="button" onClick={handleClick} className={buttonStyle}>
      ...
      <p className="pl-2">{props.topicName}</p>
    </button>
  );
};
