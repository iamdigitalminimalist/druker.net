...
// TODO: Fix the hot reload function, based on
// Add to the app's package.json: "customServerPath": "../../tools/next-watch-server/next-watch-server.ts",
// Read more: https://blog.nrwl.io/hot-reload-mdx-changes-in-next-js-and-nx-c05252cf450a
